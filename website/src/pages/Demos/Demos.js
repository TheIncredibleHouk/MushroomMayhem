...
var Demos = () => {
    ...
    return <DemoStyles>
        ...
        <>
            ...
            <PageHeader color={green}>December 12, 2023</PageHeader>
            <div className="demos-layout">
                <ul>
                    <li><a href="/patches/Mario Adventure 3 [for PRG0].ips">Patch for Super Mario Bros. 3 (PRG0) version</a></li>
                    <li><a href="/patches/Mario Adventure 3 [for PRG1].ips">Patch for Super Mario Bros. 3 (PRG1) version</a></li>
                    <li><a href="/patches/Mario Adventure 3 [for PC10].ips">Patch for Super Mario Bros. 3 (PC10) version</a></li>
                </ul>
            </div>
        </>
        } {
