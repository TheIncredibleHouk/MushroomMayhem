...
var Home = () => {
  return (
    <div className="home">
      ...
      <h1>Version 1.6.5</h1>
      <p><img src={title} /></p>
      <p>Last updated September 29, 2024 (12:30pm EST)</p>
      <p>
        ...
        with any issues you may run into the game.
        <br />
        <br />
        <h1>Casual Mode</h1>
        Not a Mario master? Want a more casual experience? Try Casual Mode!
        Simply enter hit [Down] on the d-pad 8 times to activate casual mode. An
        effect will play to let you know you've entered the code correctly!
        <ul>
          <li>
          ...
          <li>
            Holding the jump button while in the air will cause Mario to fall at
            a slower speed
          </li>
        </ul>
        <br />
        ...
        <Link to="/versions">versions</Link> link and enjoy!!
      </p>
