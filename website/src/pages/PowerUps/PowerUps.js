...
const powerUpList = [
  {
    name: "Super Mushroom",
    description:
      "Powers Mario up to Super Mario. Gives him the ability to break bricks with his bare hands!",
  ...
  },
  {
    ...
    description: (
      <>
        The classic fire power! Press <NesPadAction B /> to toss fire balls that
        can defeat many enemies and melt ice. Lob fireballs up by holding
  ...
  },
  {
    ...
    description: (
      <>
        A frosty twist on a classic. Press <NesPadAction B /> to toss ice balls
        that can freeze enemies. You can even freeze the surface of water and
        Munchers.
      </>
    ),
  ...
  },
  {
    ...
    description: (
      <>
        Give Mario some raccoon aesthetics! Charging your P-Meter and jumping
        allows Mario to fly. Batting his tail with <NesPadAction B /> allows
        Mario to knock projectiles right back at enemies!
      </>
    ),
  ...
  },
  {
    ...
    description: (
      <>
        Grow a fluffy tail with pointy ears! Fox Mario can dash forward by
        tapping <NesPadAction B /> twice. Additionally, Fox Mario is
        invulernable to fireballs and lava!
      </>
    ),
  ...
  },
  {
    ...
    description: (
      <>
        Poison Frog Mario won't lose air underwater and isn't affected by wind
        and ice when his sticky feet touch the ground. Double tapping{" "}
        <NesPadAction B /> will make Mario invincible for a bit!
      </>
    ),
  ...
  },
  {
    ...
    description: (
      <>
        Koopa Mario can go into a shell, just like a Koopa while holding{" "}
        <NesPadCross down /> once he has enough run speed. Mario will break
        bricks and even richoet off hazards from a above such as spikes and
        Munchers!
      </>
    ),
  ...
  },
  {
    ...
    description: (
      <>
        Throw sledge hammers with <NesPadAction B /> and watch as they break
        brick and stone blocks. While in the air, Mario can hold{" "}
        <NesPadCross down /> and tap <NesPadAction B /> will send him downwards
        as a ground pound attack!
      </>
    ),
  ...
  },
  {
    ...
    description: (
      <>
        Press <NesPadAction B /> to throw shurikens and hold{" "}
        <NesPadCross up down left right /> to throw them in different
        directions! Press <NesPadCross left right /> while in the air and
        against a wall and Mario will slide down. Tap <NesPadAction A /> to wall
        jump off it!
      </>
    ),
...
var PowerUps = () => {
  return (
    <>
      <h1>Power-ups</h1>
      <section>
        Mario Adventure 3 contains several returning power-ups, such as the Fire
        Flower and Raccoon Leaf! However, Mario will come across several new
        power-ups on this quest and gain new abilities for familiar ones.
        Utilize all these powers to find hidden Magic Stars, secret areas, and
        determine who is responsible for these menacing Malice Mushrooms!
      </section>
