...
var About = () => {
    return (
        <div className="about">
            ...
            <PageHeader color={green}>Luigi's Coin Quest</PageHeader>
            <div>
            ...
            <PageHeader color={red}>Luigi vs. Mario</PageHeader>
            <div>
            ...
            <PageHeader color={blue}>Reuben</PageHeader>
            <div>
            ...
            <PageHeader color={yellow}>Koopa Kingdom Escape</PageHeader>
            <div>
            ...
            <PageHeader color={blue}>Mario Adventure 3</PageHeader>
            <div>
