...
SparkDetects:
	...
	.byte (HIT_DET_LEFT | HIT_DET_GRND), (HIT_DET_RIGHT | HIT_DET_GRND), (_HIT_DET_CEIL | HIT_DET_RIGHT), (HIT_DET_LEFT | HIT_DET_CEIL)
...
ObjNorm_Spark:
	LDY Objects_Var1, X
	LDA SparkStateXVel, Y
	STA <Objects_XVel, Y
	LDA SparkStateYVel, Y
	STA <Objects_YVel, Y
	TYA
...
KeepGoing:
								; if we only detected one ground or wall we keep going in the same direction
	RTS
