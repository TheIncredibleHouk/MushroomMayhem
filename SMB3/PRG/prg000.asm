...
Object_MaxFalls:
	.byte OBJECT_MAXFALL, OBJECT_MAXFALLINWATER, OBJECT_MAXFALL, OBJECT_MAXFALLINWATER

Object_MaxAntiGravity:
	.byte -OBJECT_MAXFALL, -OBJECT_MAXFALLINWATER, OBJECT_MAXFALL, -OBJECT_MAXFALLINWATER
	; Gravity of object 
Object_Gravity:
	.byte OBJECT_FALLRATE, OBJECT_FALLRATEINWATER, OBJECT_SLOWFALLRATE, OBJECT_FALLRATEINWATER
