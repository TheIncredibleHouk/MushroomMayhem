...
; Player_GetTileV:	; $9E3C 		; UNUSED COPY FROM PRG030, DELETE DON'T MODIFY
	...
	STA Tile_LastValue	 ; Store into Tile_LastValue		; UNUSED COPY FROM PRG030, DELETE DON'T MODIFY
...
; LevelJct_GetVScreenH:		; UNUSED COPY FROM PRG030, DELETE DON'T MODIFY
	; Y = Player_YHiZ		; UNUSED COPY FROM PRG030, DELETE DON'T MODIFY
	...
	ADD PRG030_9E6C,Y	; Player_Y += Player_YHiZ[Y]		; UNUSED COPY FROM PRG030, DELETE DON'T MODIFY
...
; Player_GetTile:	; $9E9D		; UNUSED COPY FROM PRG030, DELETE DON'T MODIFY
...
PRG028_BF0D:		; UNUSED COPY FROM PRG030, DELETE DON'T MODIFY
	LDA Tile_LastValue	; A = Tile_LastValue (the tile retrieved)		; UNUSED COPY FROM PRG030, DELETE DON'T MODIFY
	RTS		 ; Return		; UNUSED COPY FROM PRG030, DELETE DON'T MODIFY
