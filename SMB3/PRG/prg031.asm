...
PRG031_F7B0:
	LDA IRQ_Mode	 ; Get status bar mode
	BEQ SwapStatus_Bar
	JMP Clear_OverScan
...
SwapStatus_Bar:
	...
	LDA #$2B	 ; Y = $0B
	STA PPU_VRAM_ADDR	 ; This is $0B unless tileset = $11, which it is then $03
	...
	STA MMC3_IRQLATCH	 ; Next interrupt in 27 lines
	STA MMC3_IRQENABLE	 ; Disable IRQ...
...
Clear_OverScan:
	...
	STA PPU_CTL2
	STA MMC3_IRQDISABLE 
	STA IRQ_Mode; Disable the IRQ generation
