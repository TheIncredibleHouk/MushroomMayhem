...
SPR_PowerUps:
	.byte OBJ_POWERUP_MUSHROOM, OBJ_POWERUP_FIREFLOWER, OBJ_ESWITCH, $FF, $FF, $FF, OBJECT_ICESPIKE, OBJ_POWERUP_PUMPKIN, OBJ_POWERUP, OBJ_POWERUP_FOXLEAF, OBJ_ESWITCH, OBJ_GROWINGVINE
...
Reserve_Sprites:
	.byte OBJ_POWERUP_MUSHROOM, OBJ_POWERUP_FIREFLOWER, OBJ_ESWITCH, OBJ_ESWITCH, OBJ_ESWITCH, OBJ_ESWITCH, OBJECT_ICESPIKE, OBJ_POWERUP_FOXLEAF, $00, OBJ_POWERUP_PUMPKIN, OBJ_POWERUP
